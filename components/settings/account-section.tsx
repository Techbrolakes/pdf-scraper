        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 p-4 sm:p-5 border border-white/10 rounded-xl bg-white/5 hover:bg-white/10 transition-all">
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 text-sm font-medium text-white bg-white/10 border border-white/20 rounded-xl hover:bg-white/20 transition-all duration-200"
            >
              Sign Out
            </button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 p-4 sm:p-5 border border-red-500/20 bg-red-500/10 rounded-xl hover:border-red-500/30 transition-all">
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 text-sm font-medium text-white bg-red-600 rounded-xl hover:bg-red-700 transition-all duration-200 hover:scale-105"
            >
              Delete Account
            </button>
          </div>
              ...
              >
                ...
                <div className="flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 sm:justify-end pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={isDeleting}
                    className="w-full sm:w-auto px-5 py-2.5 text-sm font-medium text-white bg-red-600 rounded-xl hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
